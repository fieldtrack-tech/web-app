...
/**
 * Dev-internal route guard for /admin/audit-logs.
 *
 ...
 * reach the immutable audit trail viewer in production.
 *
 * To grant access: set `app_metadata.is_dev = true` for the user via
 * the Supabase dashboard or service-role API.
 */
export default async function AuditLogsDevLayout({ children }: { children: ReactNode }) {
